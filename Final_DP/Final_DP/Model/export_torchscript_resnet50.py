...
# === EDIT if needed ===
WEIGHTS_PATH = "resnet50_finetuned.pth"   # <-- your .pth file
OUT_PATH = "resnet50_ewaste_traced.pt"
NUM_CLASSES = 9                        # <-- change if your dataset has different number of classes
# =======================
